...
public class Bat extends MeleeSoldier
{

	private static final String TAG = Bat.class.getSimpleName();
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.bat);
	...
	public Bat(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
