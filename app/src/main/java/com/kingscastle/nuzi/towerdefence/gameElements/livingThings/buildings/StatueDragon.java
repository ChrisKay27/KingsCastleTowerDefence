...
public class StatueDragon extends Building {

	private static final String TAG = "StatueDragon";

	private static final RectF staticPerceivedArea = new RectF( -Rpg.sixTeenDp , 0 , Rpg.sixTeenDp , Rpg.sixTeenDp );

	private static final Image image = Assets.loadImage(R.drawable.statue_dragon);

	private static final LivingQualities staticLivingQualities;

	private static Cost cost = new Cost( 1000 , 1000 , 1000 , 0 );

	public static final Buildings name = Buildings.StatueDragon;

	static{
		staticLivingQualities = new LivingQualities(); staticLivingQualities.setRequiresAge(Age.STONE); staticLivingQualities.setRequiresTcLvl(8);
	...
	public StatueDragon(vector v, Teams t)
	{
		super(name );
