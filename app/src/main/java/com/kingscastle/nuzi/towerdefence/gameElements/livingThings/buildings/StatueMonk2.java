...
public class StatueMonk2 extends Building {

	private static final String TAG = "StatueMonk2";

	private static final RectF staticPerceivedArea = new RectF( -Rpg.eightDp , 0 , Rpg.eightDp , Rpg.sixTeenDp );

	private static final Image image = Assets.loadImage(R.drawable.statue_monk2);

	private static final LivingQualities staticLivingQualities;

	private static Cost cost = new Cost( 0 , 1000 , 1000 , 0 );

	public static final Buildings name = Buildings.StatueMonk2;
	...
	public StatueMonk2(vector v, Teams t)
	{
		super(name );
