...
public class DwarfGinger extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.dwarf_red_beard  , 0 , 0 , 1 , 1 );
	...
	public DwarfGinger(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		DwarfGinger.imageFormatInfo = imageFormatInfo;
	}
