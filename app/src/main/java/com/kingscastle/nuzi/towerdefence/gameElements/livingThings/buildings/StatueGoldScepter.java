...
public class StatueGoldScepter extends Building {

	private static final String TAG = "StatueCross";

	private static final RectF staticPerceivedArea = new RectF( -Rpg.eightDp , 0 , Rpg.eightDp , Rpg.sixTeenDp );

	private static final Image image = Assets.loadImage(R.drawable.statue_gold_staff);

	private static final LivingQualities staticLivingQualities;

	private static Cost cost = new Cost( 1000 , 1000 , 1000 , 0 );

	public static final Buildings name = Buildings.StatueGoldScepter;

	static{
		staticLivingQualities = new LivingQualities(); staticLivingQualities.setRequiresAge(Age.STONE); staticLivingQualities.setRequiresTcLvl(12);
	...
	public StatueGoldScepter(){
		super(name);
	}

	public StatueGoldScepter(vector v, Teams t)
	{
		super(name );
