...
public class ZombieWeak extends MeleeSoldier
{
	...
	static
	{
		...
		staticAttackerQualities.setDamage( 10 );  staticAttackerQualities.setdDamageAge( 0 ); staticAttackerQualities.setdDamageLvl( 1 );
	...
	public ZombieWeak(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
