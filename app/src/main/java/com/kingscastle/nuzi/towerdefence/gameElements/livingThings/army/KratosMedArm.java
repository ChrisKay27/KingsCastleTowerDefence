...
public class KratosMedArm extends MeleeSoldier
{

	private static final String TAG = KratosMedArm.class.getSimpleName();
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.kratos_2);
		...
		staticLivingQualities.setArmor( 6 );  staticLivingQualities.setdArmorAge( 3 ); staticLivingQualities.setdArmorLvl( 1 );
	...
	public KratosMedArm(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
	...
	public void setStaticImages(Image[] staticImages) {
		KratosMedArm.staticImages = staticImages;
	}
