...
public class BlueTemplar extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.blue_templar  , 0 , 0 , 1 , 1 );
	...
	public BlueTemplar(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		BlueTemplar.imageFormatInfo = imageFormatInfo;
	}
