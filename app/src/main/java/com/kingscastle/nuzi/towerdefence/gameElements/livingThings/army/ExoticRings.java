...
public class ExoticRings extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.exoticrings  , 0 , 0 , 1 , 1 );
	...
	static
	{
		...
		staticLivingQualities.setFullHealth( 1200 );
		staticLivingQualities.setHealth( 1200 ); staticLivingQualities.setdHealthAge( 0 ); staticLivingQualities.setdHealthLvl( 30 );
		...
		staticLivingQualities.setSpeed(.65f * dp);
	}
	...
	public ExoticRings(vector loc, Teams team){
		super(team);
		setLoc(loc);
		setTeam(team);
	}
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		ExoticRings.imageFormatInfo = imageFormatInfo;
	}
