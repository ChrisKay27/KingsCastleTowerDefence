...
public class Bahamut extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.bahamut  , 0 , 0 , 1 , 1 );
	...
	public Bahamut(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		Bahamut.imageFormatInfo = imageFormatInfo;
	}
