...
public class Death extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.death  , 0 , 0 , 1 , 1 );
	...
	public Death(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		Death.imageFormatInfo = imageFormatInfo;
	}
