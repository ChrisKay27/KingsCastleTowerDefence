...
public class WeaponsSpears extends Building {

	private static final String TAG = "WeaponsSpears";

	private static final RectF staticPerceivedArea = new RectF( -Rpg.eightDp , 0 , Rpg.eightDp , Rpg.sixTeenDp );

	private static final Image image = Assets.loadImage(R.drawable.weapons_spears);

	private static final LivingQualities staticLivingQualities;

	private static Cost cost = new Cost( 1000 , 1000 , 1000 , 0 );

	public static final Buildings name = Buildings.WeaponsSpears;
	...
	public WeaponsSpears(){
		super(name);
	}

	public WeaponsSpears(vector v, Teams t)
	{
		super(name );
