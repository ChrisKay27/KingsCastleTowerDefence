...
public class VampLord extends MageSoldier
{

	private static final String TAG = VampLord.class.getSimpleName();
	private static final String NAME = "Vampire Lord";
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.vamp_lord);
		...
		staticAttackerQualities.setDamage( 50 );  staticAttackerQualities.setdDamageAge( 0 ); staticAttackerQualities.setdDamageLvl( 1 );
		...
		staticLivingQualities.setSpeed( .5f * dp );
	}
	...
	public boolean act() {
		if( checkSummonsAt < GameTime.getTime() ) {
			checkSummonsAt = GameTime.getTime() + 500;
	...
	protected void setupSpells(){
		summonAtks.add(new SummonAttack(getMM(), this, new Bat(new vector(), team), 2));
	}
	...
	public void setStaticImages(Image[] staticImages) {
		VampLord.staticImages = staticImages;
	}
