...
public class DwarfHealer extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.dwarf_healer  , 0 , 0 , 1 , 1 );
	...
	public DwarfHealer(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		DwarfHealer.imageFormatInfo = imageFormatInfo;
	}
