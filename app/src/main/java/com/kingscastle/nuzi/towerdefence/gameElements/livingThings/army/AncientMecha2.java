...
public class AncientMecha2 extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.ancient_mecha2  , 0 , 0 , 1 , 1 );
	...
	public AncientMecha2(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		AncientMecha2.imageFormatInfo = imageFormatInfo;
	}
