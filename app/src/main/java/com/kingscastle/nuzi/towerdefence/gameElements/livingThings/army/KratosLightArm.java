...
public class KratosLightArm extends MeleeSoldier
{

	private static final String TAG = KratosLightArm.class.getSimpleName();
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.kratos_1);
		...
		staticLivingQualities.setFullHealth( 30 );
		staticLivingQualities.setHealth( 30 ); staticLivingQualities.setdHealthAge( 0 ); staticLivingQualities.setdHealthLvl( 10 ); //
	...
	public KratosLightArm(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
	...
	public void setStaticImages(Image[] staticImages) {
		KratosLightArm.staticImages = staticImages;
	}
