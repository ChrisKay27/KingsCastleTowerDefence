...
public class DeathScythe extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.death_scythe  , 0 , 0 , 1 , 1 );
	...
	public DeathScythe(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		DeathScythe.imageFormatInfo = imageFormatInfo;
	}
