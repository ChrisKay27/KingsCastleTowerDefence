...
public class KratosLightArcher extends RangedSoldier
{

	private static final String TAG = KratosLightArcher.class.getSimpleName();
	...
	public KratosLightArcher(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
	...
	public void setStaticImages(Image[] staticImages) {
		KratosLightArcher.staticImages = staticImages;
	}
