...
public class Troll extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.troll  , 0 , 0 , 1 , 1 );
	...
	public Troll(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		Troll.imageFormatInfo = imageFormatInfo;
	}
