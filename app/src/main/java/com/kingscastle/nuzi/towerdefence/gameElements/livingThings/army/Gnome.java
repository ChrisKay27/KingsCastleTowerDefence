...
public class Gnome extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.dwarf_mage  , 0 , 0 , 1 , 1 );
	...
	public Gnome(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		Gnome.imageFormatInfo = imageFormatInfo;
	}
