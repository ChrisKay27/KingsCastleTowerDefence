...
public class StatuePillar3 extends Building {

	private static final String TAG = "StatuePillar3";

	private static final RectF staticPerceivedArea = new RectF( -Rpg.eightDp , 0 , Rpg.eightDp , Rpg.sixTeenDp );

	private static final Image image = Assets.loadImage(R.drawable.pillar_earth);

	private static final LivingQualities staticLivingQualities;

	private static Cost cost = new Cost( 1000 , 1000 , 1000 , 0 );

	public static final Buildings name = Buildings.StatuePillar3;
	...
	public StatuePillar3(){
		super(name);
	}

	public StatuePillar3(vector v, Teams t)
	{
		super(name );
