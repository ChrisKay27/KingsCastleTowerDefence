...
public class Mermaid extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.mermaid_1  , 0 , 0 , 1 , 1 );
	...
	public Mermaid(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		Mermaid.imageFormatInfo = imageFormatInfo;
	}
