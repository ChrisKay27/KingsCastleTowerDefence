...
public class Well2 extends Building {

	private static final String TAG = "Well2";

	private static final RectF staticPerceivedArea = new RectF( -Rpg.sixTeenDp , -Rpg.sixTeenDp , Rpg.sixTeenDp , Rpg.sixTeenDp );

	private static final Image image = Assets.loadImage(R.drawable.well2);

	private static final LivingQualities staticLivingQualities;

	private static Cost cost = new Cost( 1000 , 1000 , 1000 , 0 );

	public static final Buildings name = Buildings.Well2;
