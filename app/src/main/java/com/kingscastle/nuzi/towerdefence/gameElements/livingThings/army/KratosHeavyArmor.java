...
public class KratosHeavyArmor extends MeleeSoldier
{

	private static final String TAG = KratosHeavyArmor.class.getSimpleName();
	private static final String NAME = "Heavily Armored Kratos";
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.kratos_6);
		...
		staticAttackerQualities.setDamage( 40 );  staticAttackerQualities.setdDamageAge( 0 ); staticAttackerQualities.setdDamageLvl( 1 );
		...
		staticLivingQualities.setHealth( 800 ); staticLivingQualities.setdHealthAge( 0 ); staticLivingQualities.setdHealthLvl( 10 ); //
		staticLivingQualities.setFullMana( 0 );
		staticLivingQualities.setMana( 0 );
		staticLivingQualities.setHpRegenAmount( 1 );
		staticLivingQualities.setRegenRate( 1000 );
		staticLivingQualities.setArmor( 20 );  staticLivingQualities.setdArmorAge( 3 ); staticLivingQualities.setdArmorLvl( 1 );
	...
	public KratosHeavyArmor(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
	...
	public void setStaticImages(Image[] staticImages) {
		KratosHeavyArmor.staticImages = staticImages;
	}
