...
public class Snowman extends Building {
	...
	private static final Image image = Assets.loadImage(R.drawable.snowman);

	private static final LivingQualities staticLivingQualities;

	private static Cost cost = new Cost( 1000000 , 1000000 , 1000000 , 0 );

	public static final Buildings name = Buildings.Snowman;

	static{
		staticLivingQualities = new LivingQualities(); staticLivingQualities.setRequiresAge(Age.STONE);  staticLivingQualities.setRequiresTcLvl(18);

		staticLivingQualities.setLevel( 1 );
		staticLivingQualities.setFullHealth(10000);
		staticLivingQualities.setHealth(10000);
	...
	public Snowman(vector v, Teams t)
	{
		super(name );
