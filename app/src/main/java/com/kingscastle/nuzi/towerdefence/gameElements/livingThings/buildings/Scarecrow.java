...
public class Scarecrow extends AttackingBuilding {

	private static final String TAG = "Scarecrow";
	...
	public static final Buildings name = Buildings.Scarecrow;
	...
	static{
		...
		staticLivingQualities.setHealth(100);
