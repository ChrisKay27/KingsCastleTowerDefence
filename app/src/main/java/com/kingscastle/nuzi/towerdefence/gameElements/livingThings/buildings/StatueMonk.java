...
public class StatueMonk extends Building {

	private static final String TAG = "StatueMonk";
	...
	public static final Buildings name = Buildings.StatueMonk;
