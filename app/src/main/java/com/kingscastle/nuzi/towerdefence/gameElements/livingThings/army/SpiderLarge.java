...
public class SpiderLarge extends MeleeSoldier
{

	private static final String TAG = SpiderLarge.class.getSimpleName();
	private static final String NAME = "Large Spider";
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.spider);
		...
		staticLivingQualities.setFullHealth( 150 );
		staticLivingQualities.setHealth( 150 ); staticLivingQualities.setdHealthAge( 0 ); staticLivingQualities.setdHealthLvl( 10 ); //
	...
	public SpiderLarge(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
	}
	...
	public void setStaticImages(Image[] staticImages) {
		SpiderLarge.staticImages = staticImages;
	}
