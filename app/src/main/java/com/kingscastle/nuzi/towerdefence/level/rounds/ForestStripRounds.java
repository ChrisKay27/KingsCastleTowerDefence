...
import com.kingscastle.nuzi.towerdefence.gameElements.livingThings.army.Elder;
 ...
 */
public class ForestStripRounds {
    private static final String TAG = ForestStripRounds.class.getSimpleName();
    ...
    static{
        ...
        thingsToSpawn1.add(KratosLightArmSword.class);
        thingsToSpawn1.add(Spider.class);

        thingsToSpawn2.add(KratosLightArm.class);
        thingsToSpawn2.add(KratosLightArmSword.class);
        thingsToSpawn2.add(Spider.class);
        ...
        thingsToSpawn3.add(Spider.class);
        ...
        thingsToSpawn4.add(Spider.class);
        ...
        thingsToSpawn5.add(Spider.class);
        thingsToSpawn5.add(SpiderLarge.class);
        ...
        thingsToSpawn6.add(Spider.class);
        thingsToSpawn6.add(SpiderLarge.class);

        thingsToSpawn7.add(Spider.class);
        thingsToSpawn7.add(SpiderLarge.class);

        thingsToSpawn8.add(Coyote.class);

        thingsToSpawn9.add(KratosMedArm.class);
        thingsToSpawn9.add(KratosArmored.class);
        thingsToSpawn9.add(KratosMedArm.class);
        thingsToSpawn9.add(KratosArmored.class);
        thingsToSpawn9.add(KratosMedArm.class);
        thingsToSpawn9.add(KratosArmored.class);
        thingsToSpawn9.add(KratosMage.class);
        ...
        thingsToSpawn12.add(KratosMedArm.class);
        thingsToSpawn12.add(KratosShielded.class);
        thingsToSpawn12.add(KratosArmored.class);
        thingsToSpawn12.add(KratosMedArm.class);
        thingsToSpawn12.add(KratosShielded.class);
        ...
        thingsToSpawn13.add(KratosArmored.class);
        thingsToSpawn13.add(KratosMedArm.class);
        thingsToSpawn13.add(KratosArmored.class);
        thingsToSpawn13.add(KratosMedArm.class);
        thingsToSpawn13.add(KratosMage.class);
        thingsToSpawn13.add(KratosHeavyArmor.class);
        thingsToSpawn13.add(ExoticRings.class);
        thingsToSpawn13.add(BrownTemplar.class);
        thingsToSpawn13.add(FreakyMouse.class);

        thingsToSpawn14.add(KratosShielded.class);
        thingsToSpawn14.add(KratosMedArm.class);
        ...
        thingsToSpawn16.add(Elder.class);
