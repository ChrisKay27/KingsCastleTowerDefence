...
public class KratosShielded extends MeleeSoldier
{

	private static final String TAG = KratosShielded.class.getSimpleName();
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.kratos_4);
		...
		staticLivingQualities.setFullHealth( 80 );
		staticLivingQualities.setHealth( 80 ); staticLivingQualities.setdHealthAge( 0 ); staticLivingQualities.setdHealthLvl( 10 ); //
		staticLivingQualities.setFullMana( 0 );
		staticLivingQualities.setMana( 0 );
		staticLivingQualities.setHpRegenAmount( 1 );
		staticLivingQualities.setRegenRate( 1000 );
		staticLivingQualities.setArmor( 15 );  staticLivingQualities.setdArmorAge( 3 ); staticLivingQualities.setdArmorLvl( 1 );
	...
	public KratosShielded(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
	...
	public void setStaticImages(Image[] staticImages) {
		KratosShielded.staticImages = staticImages;
	}
