...
public class ElderWoman extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.elder  , 0 , 0 , 1 , 1 );
	...
	public ElderWoman(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		ElderWoman.imageFormatInfo = imageFormatInfo;
	}
