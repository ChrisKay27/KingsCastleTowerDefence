...
public class UndeadSkeletonWarrior extends BasicMeleeSoldier
{

	private static final String TAG = "UndeadSkeletonWarrior";
	...
	static
	{
		...
		imageFormatInfo = new ImageFormatInfo( 0 , 0 ,
				2 , 0 , 4 , 2 );
		imageFormatInfo.setRedId(R.drawable.skeleton_warrior_red);
		...
		staticLivingQualities.setHealth( 40 ); staticLivingQualities.setdHealthAge( 0 ); staticLivingQualities.setdHealthLvl( 10 ); //
		staticLivingQualities.setFullMana( 0 );
		staticLivingQualities.setMana( 0 );
		staticLivingQualities.setHpRegenAmount( 1 );
		staticLivingQualities.setRegenRate( 1000 );
		staticLivingQualities.setArmor( 2 );  staticLivingQualities.setdArmorAge( 3 ); staticLivingQualities.setdArmorLvl( 1 );
	...
	public UndeadSkeletonWarrior( vector loc , Teams team )
	{
		super(team);
		setLoc( loc );
	}
	...
	public void setStaticImages(Image[] staticImages) {
		UndeadSkeletonWarrior.staticImages = staticImages;
	}
	...
	public static void setCost(Cost cost) {
		UndeadSkeletonWarrior.cost = cost;
	}
