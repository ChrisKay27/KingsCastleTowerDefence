...
public class BlackFace extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.black_face  , 0 , 0 , 1 , 1 );
	...
	public BlackFace(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		BlackFace.imageFormatInfo = imageFormatInfo;
	}
