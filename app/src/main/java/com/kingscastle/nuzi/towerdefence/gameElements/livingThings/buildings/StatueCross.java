...
public class StatueCross extends Building {
	...
	private static final Image image = Assets.loadImage(R.drawable.statue_cross);

	private static final LivingQualities staticLivingQualities;

	private static Cost cost = new Cost( 1000 , 1000 , 1000 , 0 );

	public static final Buildings name = Buildings.StatueCross;

	static{
		staticLivingQualities = new LivingQualities(); staticLivingQualities.setRequiresAge(Age.STONE);  staticLivingQualities.setRequiresTcLvl(13);
	...
	public StatueCross(vector v, Teams t)
	{
		super(name );
