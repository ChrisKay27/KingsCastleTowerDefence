...
public class DwarfSoldier extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.dwarf_soldier  , 0 , 0 , 1 , 1 );
	...
	public DwarfSoldier(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		DwarfSoldier.imageFormatInfo = imageFormatInfo;
	}
