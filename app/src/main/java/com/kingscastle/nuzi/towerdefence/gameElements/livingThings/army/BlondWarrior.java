...
public class BlondWarrior extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.blonde_warrior  , 0 , 0 , 1 , 1 );
	...
	public BlondWarrior(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		BlondWarrior.imageFormatInfo = imageFormatInfo;
	}
