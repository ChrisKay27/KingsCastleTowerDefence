...
public class AncientMecha extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.ancient_mecha  , 0 , 0 , 1 , 1 );
	...
	public AncientMecha(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		AncientMecha.imageFormatInfo = imageFormatInfo;
	}
