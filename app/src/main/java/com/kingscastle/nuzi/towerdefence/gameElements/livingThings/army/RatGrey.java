...
public class RatGrey extends MeleeSoldier
{

	private static final String TAG = RatGrey.class.getSimpleName();
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.giant_rat_grey);
		...
		staticAttackerQualities.setDamage( 6 );  staticAttackerQualities.setdDamageAge( 0 ); staticAttackerQualities.setdDamageLvl( 1 );
	...
	public RatGrey(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
	...
	public void setStaticImages(Image[] staticImages) {
		RatGrey.staticImages = staticImages;
	}
