...
public class StatuePillar2 extends Building {

	private static final String TAG = "StatuePillar2";

	private static final RectF staticPerceivedArea = new RectF( -Rpg.eightDp , 0 , Rpg.eightDp , Rpg.sixTeenDp );

	private static final Image image = Assets.loadImage(R.drawable.pillar_frost);

	private static final LivingQualities staticLivingQualities;

	private static Cost cost = new Cost( 0 , 1000 , 1000 , 0 );

	public static final Buildings name = Buildings.StatuePillar2;

	static{
		staticLivingQualities = new LivingQualities(); staticLivingQualities.setRequiresAge(Age.BRONZE); staticLivingQualities.setRequiresTcLvl(7);
	...
	public StatuePillar2(){
		super(name);
	}

	public StatuePillar2(vector v, Teams t)
	{
		super(name );
