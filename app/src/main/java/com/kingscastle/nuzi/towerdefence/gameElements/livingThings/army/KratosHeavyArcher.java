...
public class KratosHeavyArcher extends RangedSoldier
{

	private static final String TAG = KratosHeavyArcher.class.getSimpleName();
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.kratos_8);
	...
	public void setStaticImages(Image[] staticImages) {
		KratosHeavyArcher.staticImages = staticImages;
	}
