...
public class GoldenCapedSoldier extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.helmeted_grey_and_gold_soldier  , 0 , 1 , 1 , 2 );
	...
	public GoldenCapedSoldier(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		GoldenCapedSoldier.imageFormatInfo = imageFormatInfo;
	}
