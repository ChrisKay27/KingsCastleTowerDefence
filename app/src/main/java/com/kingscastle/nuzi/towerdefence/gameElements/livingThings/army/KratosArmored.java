...
public class KratosArmored extends MeleeSoldier
{

	private static final String TAG = KratosArmored.class.getSimpleName();
	private static final String NAME = "Armored Kratos";
	...
	static
	{
		...
		imageFormatInfo.setID(R.drawable.kratos_5);
		...
		staticAttackerQualities.setDamage( 22 );  staticAttackerQualities.setdDamageAge( 0 ); staticAttackerQualities.setdDamageLvl( 1 );
		...
		staticLivingQualities.setHealth( 600 ); staticLivingQualities.setdHealthAge( 0 ); staticLivingQualities.setdHealthLvl( 10 ); //
		staticLivingQualities.setFullMana( 0 );
		staticLivingQualities.setMana( 0 );
		staticLivingQualities.setHpRegenAmount( 1 );
		staticLivingQualities.setRegenRate( 1000 );
		staticLivingQualities.setArmor( 12 );  staticLivingQualities.setdArmorAge( 3 ); staticLivingQualities.setdArmorLvl( 1 );
	...
	public KratosArmored(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
	...
	public void setStaticImages(Image[] staticImages) {
		KratosArmored.staticImages = staticImages;
	}
