...
public class SkeletonWarlock extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.skeleton_businessman , 0 , 0 , 1 , 1 );
	...
	public SkeletonWarlock(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		SkeletonWarlock.imageFormatInfo = imageFormatInfo;
	}
