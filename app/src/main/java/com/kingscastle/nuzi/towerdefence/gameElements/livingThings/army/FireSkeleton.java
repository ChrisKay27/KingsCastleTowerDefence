...
public class FireSkeleton extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.skeleton_blood_demonic_fire_cape  , 0 , 0 , 1 , 1 );
	...
	public FireSkeleton(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		FireSkeleton.imageFormatInfo = imageFormatInfo;
	}
