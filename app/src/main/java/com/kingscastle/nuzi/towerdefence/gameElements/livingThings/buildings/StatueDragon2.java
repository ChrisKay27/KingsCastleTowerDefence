...
public class StatueDragon2 extends Building {
	...
	static{
		staticLivingQualities = new LivingQualities(); staticLivingQualities.setRequiresAge(Age.STONE);  staticLivingQualities.setRequiresTcLvl(9);
	...
	public StatueDragon2(vector v, Teams t)
	{
		super(name );
