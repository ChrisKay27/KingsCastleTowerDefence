...
public class Pigeon extends MeleeSoldier
{

	private static final String TAG = Pigeon.class.getSimpleName();
	private static final String NAME = "Pigeon";
	...
	public Pigeon(vector loc, Teams team)
	{
		super(team);
		setLoc( loc );
		super.team = team;
	...
	public void setStaticImages(Image[] staticImages) {
		Pigeon.staticImages = staticImages;
	}
