...
public class Dragoon extends MeleeSoldier {

	private static ImageFormatInfo imageFormatInfo;
	private static Image[] images = Assets.loadImages( R.drawable.drow_male1  , 0 , 0 , 1 , 1 );
	...
	public Dragoon(vector loc, Teams team){
		super(team);
		setLoc(loc);
	...
	public void setImageFormatInfo(ImageFormatInfo imageFormatInfo) {
		Dragoon.imageFormatInfo = imageFormatInfo;
	}
